          ...
          <>
            ...
            <PremiumCard accent="slate" delay={0.12}>
              <div className="neuro-arena-mode neuro-arena-mode--matrix">
                ...
                <p className="text-sm text-[var(--color-text-secondary)] mb-4 leading-relaxed">
                  Сетка из девяти ячеек: сначала загорается цепочка — её повторяете по порядку. После каждого верного
                  раунда цепочка длиннее, а параллельно{' '}
                  <span className="text-[var(--color-text-primary)] font-medium">собирается спокойная фраза</span> —
                  слово за словом, до цельной строки.
                </p>
              </div>
              <button
                type="button"
