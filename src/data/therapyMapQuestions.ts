...
export const THERAPY_MAP_QUESTIONS: {
  ...
  {
    id: 'between_sessions',
    text: 'Как ты видишь связь со специалистом между встречами — только на приёме, короткие сообщения в мессенджере (если у специалиста так принято), письменно по договорённости или пока без контакта вне сессий? Это пожелания на старт; точный формат всегда можно уточнить в кабинете.',
    shortEligible: true,
    includeInShortByDefault: false,
  },
]
